...
class DoubleLeftButton: NSButton {
	...
	override func draw(_ dirtyRect: NSRect) {
		...
		arrow2Path.move(to: NSPoint(x: 10.93, y: 7))
		arrow2Path.line(to: NSPoint(x: 7, y: 11))
		arrow2Path.line(to: NSPoint(x: 10.93, y: 15))
		...
		arrow1Path.move(to: NSPoint(x: 14.75, y: 7))
		arrow1Path.line(to: NSPoint(x: 10.82, y: 11))
		arrow1Path.line(to: NSPoint(x: 14.75, y: 15))
